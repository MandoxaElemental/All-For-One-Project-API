...
namespace All_For_One_Project_API.Controllers
{
    ...
    public class MadLibController : ControllerBase
    {
        ...
        [HttpGet]
        [Route("MadLib{color}/{pluralNoun1}/{location}/{verb1}/{verb2}/{noun1}/{adjective1}/{pluralObject}/{noun2}/{verb3}/{pluralNoun2}/{adjective2}/{pluralNoun3}/{adverb1}/{verb4}/{adverb2}")]
